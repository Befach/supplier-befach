  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Supplier Header - Single Card Layout */}
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 md:p-6 mb-6">
          <div className="flex flex-col lg:flex-row items-start gap-8">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <h1 className="text-xl md:text-2xl font-bold text-gray-900 mb-1">{supplier.name}</h1>
                  {supplier.city && (
                  ...
                  {/* Company details in stacked format */}
            ...
            {/* Right: CTAs Only */}
            <div className="flex flex-col items-start gap-4 min-w-[220px] w-full lg:w-auto lg:max-w-xs">
              <Button 
                className="w-full h-10 bg-orange-500 hover:bg-orange-600 text-white text-sm font-semibold rounded"
              ...
              <Button 
                variant="outline" 
                className="w-full h-10 border-orange-200 text-orange-500 hover:bg-orange-50 text-sm font-semibold rounded"
